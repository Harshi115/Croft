...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    footerAboutText: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    statLabel1: Schema.Attribute.String;
    statLabel2: Schema.Attribute.String;
    statLabel3: Schema.Attribute.String;
    statValue1: Schema.Attribute.String;
    statValue2: Schema.Attribute.String;
    statValue3: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    closingCtaLabel: Schema.Attribute.String;
    closingHeading: Schema.Attribute.String;
    closingImage: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredCtaLabel: Schema.Attribute.String;
    featuredEyebrow: Schema.Attribute.String;
    featuredHeading: Schema.Attribute.String;
    heroCarouselSlides: Schema.Attribute.Component<
      'sections.carousel-slide',
      true
    >;
    ...
    heroImage: Schema.Attribute.Media<'images'>;
    heroSupportingCopy: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    servicesCtaLabel: Schema.Attribute.String;
    ...
    statValue2: Schema.Attribute.String;
    statValue3: Schema.Attribute.String;
    trustLogos: Schema.Attribute.Media<'images', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    heroImage: Schema.Attribute.Media<'images'>;
    legacySlug: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    announcementBanner: Schema.Attribute.Component<
      ...
      false
    >;
    builderLicences: Schema.Attribute.JSON;
    companyName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    enquiryNotificationRecipients: Schema.Attribute.JSON;
